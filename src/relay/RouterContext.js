...
import getRouteParams from 'relay/getRouteParams';
import { ContextProvider } from './ContextProvider';

function isValidChild(obj) {
  return obj == null || React.isValidElement(obj);
}

function isReactChildren(obj) {
  return isValidChild(obj) || (Array.isArray(obj) && object.every(isValidChild));
}
